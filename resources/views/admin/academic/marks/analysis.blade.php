    ...
    <x-section>
        <x-card class="card-secondary" icon="fa-edit" :title="$title">
            <form role="form" action="{{ route('marks.scores.analysed') }}">
                @csrf
                <div class="row">
                    <x-form.select class="col-md-6 col-sm-12" value="" label="Student Class" name="section_numeric">
                    ...
                    <x-form.select class="col-md-6 col-sm-12" value="" label="Exams" name="exams">
