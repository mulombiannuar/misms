    ...
    <div>
                ...
                <table>
                    <tr>
                        <td style="border-style: none;">
                            <div class="photo">
                                <img src="{{ asset('assets/dist/img/users/' . $student->studentData->student_image) }}"
                                    width="100%">
                            </div>
                        </td>
                        <td style="border-style: none;">
                            <div class="header-image">
                                <img src="{{ asset('storage/assets/dist/img/system/miems-exam-header.jpg') }}" width="100%">
                            </div>
                        </td>
                        <td style="border-style: none;">
                            <div class="photo">
        ...
        <div class="details position-top">
            <table>
                <thead>
                    <tr>
                        <th style="border-style: none;">NAME : {{ strtoupper($student->studentData->name) }}</th>
                        <th style="border-style: none;">ADM. NO : {{ strtoupper($student->studentData->admission_no) }}</th>
        ...
        <div class="scores">
            ...
            <div class="graph" style="margin-bottom: 10px; border:solid 1px; padding: 10px;">
                <img src="data:image/png;base64,{{ base64_encode($graph) }}" />
            </div>
