                ...
                <form id="accessForm" action="{{ route('verify.token') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" name="access_token" id="access_token" class="form-control"
                            placeholder="Enter access token sent to your phone/email" autocomplete="off" required autofocus>
                    </div>
                    <div class="row">
                        <!-- /.col -->
                        <div class="col-12">
                            <button type="submit" id="submit" disabled class="btn btn-success btn-block">Verify Access
                                Token</button>
                        </div>
                        <!-- /.col -->
                    </div>
